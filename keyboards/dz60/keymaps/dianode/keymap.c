...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_DEFAULT] = KEYMAP_2_SHIFTS(
		...
		KC_LSFT,  KC_GRV,   KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  XXXXX,    KC_LSFT,  KC_MEH,
		KC_LCTL,  KC_LALT,            KC_LGUI,  XXXXX,              KC_SPC,             XXXXX,              KC_RGUI,  MO(3),    XXXXX,    MO(2),    KC_HYPR
  ),

	[_EXTENDED] = KEYMAP_2_SHIFTS(
